#!/usr/bin/env python3
"""Reassemble sabda_evening_room_viewer.html from slim HTML + .b64 assets."""
import os

slim = 'sabda_evening_room_viewer_slim.html'
output = 'sabda_evening_room_viewer_full.html'
...
for aid in ['skydata', 'skydata_b', 'birdsdata', 'planetdata', 'saturndata']:
    if aid == 'saturndata':
        ...
        b64_path = os.path.join('assets_evening', f'{aid}.b64')
